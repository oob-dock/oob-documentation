...
![OPUS Open Finance Overview](./images/visao-geral.png)
...
![OPUS Open Finance Solution Modules](./images/modulos.png)
...
![Sequence Diagram for PISP and Data Reception with and without OPUS Open Finance](./images/diag-seq-itp.png)
...
![OPUS Open Data Receiver Schematic Diagram](./images/opus-open-data-receiver.png)
...
![OPUS Open Finance Architecture Overview](./images/visao-geral-solucao.png)
...
![OPUS Open Finance Architecture](./images/arquitetura.png)
...
![Metrics Collection Platform](./images/pcm.png)
...
![OPUS Open Finance Event Queue](./images/eventos.png)
...
![OPUS Open Finance Backoffice Portal](./images/backoffice.png)
...
The platform also offers an optional handoff module that can be customized with images definitions, color palettes, informative texts, and links to Android/iOS app download stores.
...
![TPP Quick Simulator](./images/quick-simulator.png)
...
1. Useful Tools
    1. Connector debugging: [Connector Tester](additional-tools/connector-tester/readme.md)
